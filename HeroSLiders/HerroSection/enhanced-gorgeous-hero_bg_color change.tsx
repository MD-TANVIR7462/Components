    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          animate={{
            background: [
              "linear-gradient(to bottom right, rgba(59, 130, 246, 0.3), rgba(147, 51, 234, 0.3), rgba(236, 72, 153, 0.3))",
              "linear-gradient(to bottom right, rgba(236, 72, 153, 0.3), rgba(59, 130, 246, 0.3), rgba(147, 51, 234, 0.3))",
              "linear-gradient(to bottom right, rgba(147, 51, 234, 0.3), rgba(236, 72, 153, 0.3), rgba(59, 130, 246, 0.3))",
            ],
          }}
        ...
        <div className="w-full lg:w-1/2 h-[400px] sm:h-[500px] lg:h-[600px] relative">
          <div className="absolute inset-0">
            <Image
              ...
              width={600}
              height={600}
              className="object-cover object-center rounded-3xl shadow-2xl w-full h-full transition-opacity duration-500"
